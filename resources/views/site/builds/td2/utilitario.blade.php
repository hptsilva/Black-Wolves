...
<html lang="pt-br">
    <head>
        <title>Utilitário | Black Wolves</title>
        ...
        <div class='titulo-build'>
            <nav class="navbar navbar-expand-sm">
                <div class='nav-builds'>
                    ...
                    <a href="{{route('defensivo')}}" class="btn btn-secondary">DEFENSIVO</a>
                    <a href="{{route('utilitario')}}" class="btn btn-secondary" style="color: #fc6e0d;">UTILITÁRIO</a>
